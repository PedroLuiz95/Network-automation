...
class main():
    def __init__(self):
        equipamentos = [{'ip':'10.95.1.1','usuario':'usuario1','senha':'senha1'},\
            {'ip':'10.95.1.3','usuario':'usuario2','senha':'senha2'}] 
        instancias = []
        dado_saida = []
        with Pool(2) as p:
...
class conexao_equipamento():
    def __init__(self,dado):
        ...
        self.dado_host = {self.ip:lista_interface}
